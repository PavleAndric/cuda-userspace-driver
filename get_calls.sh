...
HEADER_PATH_10="../ide_cuda/open-gpu-kernel-modules/src/common/sdk/nvidia/inc/ctrl/ctrl83de"
HEADER_PATH_11="../ide_cuda/open-gpu-kernel-modules/kernel-open/nvidia-uvm/"
HEADER_PATH_12="../ide_cuda/open-gpu-kernel-modules/src/nvidia/interface/deprecated"
HEADER_PATH_13="../ide_cuda/open-gpu-kernel-modules/src/common/sdk/nvidia/inc/ctrl/ctrla06f"

nvcc primer.cu -I"$HEADER_PATH_1" -I"$HEADER_PATH_9" -g -o primer  -lcuda
clang++ intercept.cc -g -G -lineinfo -shared -fPIC -ldl -lstdc++ -I"$HEADER_PATH_13" -I"$HEADER_PATH_12" -I"$HEADER_PATH_7" -I"$HEADER_PATH_11" -I"$HEADER_PATH_10" -I"$HEADER_PATH_1" -I"$HEADER_PATH_2" -I"$HEADER_PATH_3"  -I"$HEADER_PATH_5" -I"$HEADER_PATH_6"  -I"$HEADER_PATH_8" -I"$HEADER_PATH_9" -o intercept.so
