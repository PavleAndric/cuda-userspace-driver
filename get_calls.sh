...
clang intercept.cc -g -shared -fPIC -ldl -I"$HEADER_PATH_11" -I"$HEADER_PATH_10" -I"$HEADER_PATH_1" -I"$HEADER_PATH_2" -I"$HEADER_PATH_3"  -I"$HEADER_PATH_5" -I"$HEADER_PATH_6" -I"$HEADER_PATH_7" -I"$HEADER_PATH_8" -I"$HEADER_PATH_9" -o intercept.so
