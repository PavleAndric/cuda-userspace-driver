...
clang++ cuda_init.cc -G -shared -fPIC -ldl -I"$HEADER_PATH_1"  -I"$HEADER_PATH_2" -I"$HEADER_PATH_3" -I"$HEADER_PATH_4" -I"$HEADER_PATH_5" -o cuda_init.o #&& ./cuda_init
LD_PRELOAD=./intercept.so ./cuda_init.o